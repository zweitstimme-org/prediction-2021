...
pdf("output/paper/appendix_figure1.pdf", width = 12, height = 8)
...
# Previous Voteshare
plot(ger_df_long$voteshare_l1, ger_df_long$voteshare, xaxt = "n", yaxt = "n", xlab = "", ylab = "", main = "(a)", xlim = c(0, 50), ylim = c(0, 50), bty = "n")
...
eng_label <- c("CDU/CSU '53", "Others '53", "SPD '09", "CDU/CSU '13", "FDP '13")
...
# Polls 200-230 days prior to election
plot(ger_df_long$polls_200_230, ger_df_long$voteshare, xaxt = "n", yaxt = "n", xlab = "", ylab = "", main = "(b)", xlim = c(0, 60), ylim = c(0, 60), bty = "n")
axis(1, seq(0, 100, 10), seq(0, 100, 10))
...
# plot labels of outliers based on resid or cooksd 
label_position <- ifelse(model_out_aug$.resid > 0, 3, 1)
eng_label <- c("CDU/CSU '53", "FDP '53", "CDU/CSU '57", "SPD '57", "FDP '61", "CDU/CSU '65", "SPD '65", "CDU/CSU '83", "SPD '83", "CDU/CSU '94", "Greens '13")
...
# plot labels of outliers based on resid or cooksd 
eng_label <- c("SPD '09", "SPD '13", "SPD '53", "CDU/CSU '09", "SPD '05", "CDU/CSU '57", "CDU/CSU '76", "CDU/CSU '83")
text(model_out_aug$chancellor_party[obs_id], model_out_aug$voteshare[obs_id], label = eng_label, cex = .9, pos = model_out_aug$label_position[obs_id], offset = .47)
grid()
dev.off()