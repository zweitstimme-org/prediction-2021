...
saveRDS(results, file = paste0("../../output/ger/draws/structural_pre_train/", Election, "_structural_pre_train_stan.RDS"))
...
saveRDS(structural_forecast, file = paste0("../../output/ger/forecasts/structural/", Election, "_structural_forecast.RDS"))
...
saveRDS(structural_inits, paste0("../../data/ger/structural_inits/", Election,"_structural_inits.RDS"))
...
pdf(file=paste0("../../output/ger/plots/structural_pre_train/", Election,"_coefplot.pdf"), height=8, width=6, family="URWTimes")
par(mar=c(4,4,2,0)+.1)
par(oma=c(0,4,4,0)+.1)
par(mfrow=c(3,1))
#par(xaxs='i')
