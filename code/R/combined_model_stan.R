...
structural_inits <- readRDS(paste0("../../data/structural_inits/", Election, "_structural_inits.RDS"))
...
saveRDS(results, file = paste0("../../output/draws/combined_model/res_brw_", Election,"_",cutoff,".RDS"))
...
saveRDS(draws_forecast_levels, 
        file=paste0("../../output/draws/combined_model/draws_forcast_levels_",Election,"_",cutoff,".RDS")
)
}
}
